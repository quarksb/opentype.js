...
import { parse, Glyph, Path } from '../src/opentype';
import { readFileSync } from 'fs';
import { createMockObject } from './testutil';
...
describe('glyph', function() {
    ...
    describe('SVG handling', function() {
        it('should flip the path Y coordinates when generating or parsing SVG paths', function() {
            ...
            // @TODO: we'll be able to by leveraging the new mock functionality in testutil
...
describe('glyph on low memory mode', function() {
