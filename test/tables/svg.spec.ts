...
import svg from '../../src/tables/svg';
import { readFileSync } from 'fs';
import { parse } from '../../src/opentype';
import { decodeSvgDocument } from '../../src/svgimages';
const loadSync = (url, opt) => parse(readFileSync(url), opt);

/** @typedef {import('../src/tables/svg').SVGTable} SVGTable */

describe('tables/svg', function () {
    /**
     * @type {Array<SVGTable>}
     */
    const svgTables = [
