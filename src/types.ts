// Data types and interfaces for opentype.js
...
export interface Path {
    ...
    close(): void;
    closePath(): void;
    extend(pathOrCommands: Path | BoundingBox | PathCommand[]): void;
...
export interface Glyph {
    ...
    getContours(): any[][];
    getMetrics(): any;
    draw(ctx: CanvasRenderingContext2D, x?: number, y?: number, fontSize?: number, options?: any, font?: Font): void;
    drawPoints(ctx: CanvasRenderingContext2D, x?: number, y?: number, fontSize?: number, options?: any, font?: Font): void;
    drawMetrics(ctx: CanvasRenderingContext2D, x?: number, y?: number, fontSize?: number): void;
    toPathData(options?: any, font?: Font): string;
    toSVG(options?: any, font?: Font): string;
    toDOMElement(options?: any, font?: Font): SVGPathElement;
}
...
export interface Font {
    ...
    stringToGlyphs(s: string, options?: any): Glyph[];
    ...
    forEachGlyph(text: string, x: number, y: number, fontSize: number, options: any, callback: (glyph: Glyph, x: number, y: number, fontSize: number, options: any) => void): number;
...
export interface Table {
    tableName: string;
    fields: any[];
    parse: (data: DataView, offset: number) => any;
    encode: (table: any) => number[];
    sizeOf: (table: any) => number;
}

export const LIMIT16 = 32768; // The limit at which a 16-bit number switches signs == 2^15
export const LIMIT32 = 2147483648; // The limit at which a 32-bit number switches signs == 2 ^ 31

export const MIN_16_16 = -(1 << 15); // lower limit for floats in 16.16 representation
export const MAX_16_16 = (1 << 15) - 1 + (1 / (1 << 16)); // upper limit for floats in 16.16 representation
...
// No explicit export needed here as they are exported at declaration
